...
// -------- For Timing --------;
import timing.ARPS10X0X5__master_tim_mfh.Tim_multiportspec_scan_merge_spec;
import timing.ARPS10X0X5__master_tim_mfh.EQNSET6.Tim_eqn6_set1_using_pALL_PINS_;
import timing.ARPS10X0X5__master_tim_mfh.EQNSET8.Tim_eqn8_set1_using_P_ALL_EXP_SPI;
// -------- For Wavetable --------;
import wavetables.ARPS10X0X5__master_tim_mfh.Wvt_Multiport_Scan_merge_spec;
spec Spc_Lev_eqn3_spec1_set1_Tim_scan_merge_spec_set1_set1 {
  // For timing primary set
  setup digInOut pALL_PINS_ {
    settings.timing = timingSet_1_EQNSET6;
  }
