...
// -------- For Level --------;
import levels.ARPS10X0X5__master_lev_mfh.Lev_eqn1_spec1;
import levels.ARPS10X0X5__master_lev_mfh.EQNSET1.Lev_eqn1_set1;
// -------- For Timing --------;
...
spec Spc_Lev_eqn1_spec1_set1_Tim_timing_spec_set1 {
