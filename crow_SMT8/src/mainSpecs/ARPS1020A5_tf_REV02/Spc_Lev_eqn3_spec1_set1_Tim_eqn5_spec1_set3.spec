...
// -------- For Timing --------;
import timing.ARPS10X0X5__master_tim_mfh.Tim_eqn5_spec1;
import timing.ARPS10X0X5__master_tim_mfh.EQNSET5.Tim_eqn5_set3;
// -------- For Wavetable --------;
import wavetables.ARPS10X0X5__master_tim_mfh.Wvt_SPI_WAVETABLE;
spec Spc_Lev_eqn3_spec1_set1_Tim_eqn5_spec1_set3 { }
